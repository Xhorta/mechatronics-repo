...
for i = 1:N
    ...
    %% Link FG
    % FF - FG + WFG + Fartifact = mFG*aS5
    A_dynamic(13,11)=1; 
    A_dynamic(13,13)=-1;
    B_dynamic(13)=mFG*aS5_all(i,1)-WFG(1)-Fartifact(1);

    A_dynamic(14,12)=1; 
    A_dynamic(14,14)=-1;
    B_dynamic(14)=mFG*aS5_all(i,2)-WFG(2)-Fartifact(2);

    % Moments about S5
    A_dynamic(15,11:12)= momentCoeff(Fi-S5i);
    A_dynamic(15,13:14)=-momentCoeff(Gi-S5i);
    artifactMomentDynamic=(Hi(1)-S5i(1))*Fartifact(2) - (Hi(2)-S5i(2))*Fartifact(1);
